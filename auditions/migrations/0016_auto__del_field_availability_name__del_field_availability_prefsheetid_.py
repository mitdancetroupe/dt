...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('auditions_availability', ['prefsheetid', 'day', 'hour'])

        # Deleting field 'Availability.name'
        db.delete_column('auditions_availability', 'name')

        # Deleting field 'Availability.prefsheetid'
        db.delete_column('auditions_availability', 'prefsheetid')

        # Adding field 'Availability.prefsheet'
        db.add_column('auditions_availability', 'prefsheet',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='availabilities', to=orm['auditions.PrefSheet']),
                      keep_default=False)
    ...
    models = {
        'auditions.availability': {
            ...
            'prefsheet': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'related_name': "'availabilities'", 'to': "orm['auditions.PrefSheet']"})
        },
        'auditions.pref': {
