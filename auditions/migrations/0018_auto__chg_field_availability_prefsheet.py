...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('auditions_availability', 'prefsheet_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auditions.PrefSheet']))

    def backwards(self, orm):

        # Changing field 'Availability.prefsheet'
        db.alter_column('auditions_availability', 'prefsheet_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auditions.PrefSheet']))
    ...
    models = {
        'auditions.availability': {
            ...
            'prefsheet': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'availabilities'", 'null': 'True', 'to': "orm['auditions.PrefSheet']"})
        },
        'auditions.pref': {
