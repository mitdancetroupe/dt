...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('auditions_prefsheet', 'accepted_dances',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PrefSheet.rejected_dances'
        db.add_column('auditions_prefsheet', 'rejected_dances',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('auditions_prefsheet', 'accepted_dances')

        # Deleting field 'PrefSheet.rejected_dances'
        db.delete_column('auditions_prefsheet', 'rejected_dances')
