...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('auditions_availability', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('prefsheet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auditions.PrefSheet'])),
            ('time', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auditions.Time'])),
            ('available', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('auditions', ['Availability'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('auditions_availability')
    ...
    models = {
        'auditions.availability': {
            ...
            'time': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auditions.Time']"})
        },
        'auditions.pref': {
