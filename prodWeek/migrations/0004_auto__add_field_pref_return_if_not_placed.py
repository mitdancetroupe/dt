...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pref.return_if_not_placed'
        db.add_column('prodWeek_pref', 'return_if_not_placed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pref.return_if_not_placed'
        db.delete_column('prodWeek_pref', 'return_if_not_placed')
