...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PrefSheet.accepted_dances'
        db.add_column('prodWeek_prefsheet', 'accepted_dances',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PrefSheet.rejected_dances'
        db.add_column('prodWeek_prefsheet', 'rejected_dances',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PrefSheet.accepted_dances'
        db.delete_column('prodWeek_prefsheet', 'accepted_dances')

        # Deleting field 'PrefSheet.rejected_dances'
        db.delete_column('prodWeek_prefsheet', 'rejected_dances')
    ...
    models = {
        ...
        'prodWeek.prefsheet': {
            ...
            'accepted_dances': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rejected_dances': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
