...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('prodWeek_availability', ['prefsheet_id', 'time_id'])

        # Removing unique constraint on 'Time', fields ['day', 'hour']
        db.delete_unique('prodWeek_time', ['day', 'hour'])

        # Deleting model 'Time'
        db.delete_table('prodWeek_time')

        # Deleting field 'Availability.time'
        db.delete_column('prodWeek_availability', 'time_id')

        # Adding field 'Availability.day'
        db.add_column('prodWeek_availability', 'day',
                      self.gf('django.db.models.fields.CharField')(default='m', max_length=12),
                      keep_default=False)

        # Adding field 'Availability.hour'
        db.add_column('prodWeek_availability', 'hour',
    ...
    def backwards(self, orm):
        ...
        db.send_create_signal('prodWeek', ['Time'])

        # Adding unique constraint on 'Time', fields ['day', 'hour']
        db.create_unique('prodWeek_time', ['day', 'hour'])

        # Adding field 'Availability.time'
        db.add_column('prodWeek_availability', 'time',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['prodWeek.Time']),
                      keep_default=False)

        # Deleting field 'Availability.day'
        db.delete_column('prodWeek_availability', 'day')

        # Deleting field 'Availability.hour'
        db.delete_column('prodWeek_availability', 'hour')

        # Adding unique constraint on 'Availability', fields ['prefsheet', 'time']
        db.create_unique('prodWeek_availability', ['prefsheet_id', 'time_id'])
    ...
    models = {
        'prodWeek.availability': {
            ...
            'prefsheet': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['prodWeek.PrefSheet']"})
        },
        'prodWeek.pref': {
