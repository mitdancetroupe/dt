...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PrefSheet.availability'
        db.delete_column('prodWeek_prefsheet', 'availability')


    def backwards(self, orm):
        # Adding field 'PrefSheet.availability'
        db.add_column('prodWeek_prefsheet', 'availability',
