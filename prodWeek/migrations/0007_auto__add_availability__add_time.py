...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('prodWeek_availability', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('prefsheet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prodWeek.PrefSheet'])),
            ('time', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prodWeek.Time'])),
            ('available', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('prodWeek', ['Availability'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('prodWeek_availability')
    ...
    models = {
        'prodWeek.availability': {
            ...
            'time': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['prodWeek.Time']"})
        },
        'prodWeek.pref': {
