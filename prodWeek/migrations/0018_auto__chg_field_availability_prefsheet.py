...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Availability.prefsheet'
        db.alter_column('prodWeek_availability', 'prefsheet_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['prodWeek.PrefSheet']))

    def backwards(self, orm):

        # Changing field 'Availability.prefsheet'
        db.alter_column('prodWeek_availability', 'prefsheet_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prodWeek.PrefSheet']))
    ...
    models = {
        'prodWeek.availability': {
            ...
            'prefsheet': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'availabilities'", 'null': 'True', 'to': "orm['prodWeek.PrefSheet']"})
        },
        'prodWeek.pref': {
