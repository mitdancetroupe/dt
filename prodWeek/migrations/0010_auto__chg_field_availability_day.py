...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('prodWeek_availability', 'day', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'Availability.day'
        db.alter_column('prodWeek_availability', 'day', self.gf('django.db.models.fields.CharField')(max_length=12))
