...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Availability', fields ['prefsheetid', 'day', 'hour']
        db.delete_unique('prodWeek_availability', ['prefsheetid', 'day', 'hour'])

        # Deleting field 'Availability.name'
        db.delete_column('prodWeek_availability', 'name')

        # Deleting field 'Availability.prefsheetid'
        db.delete_column('prodWeek_availability', 'prefsheetid')

        # Adding field 'Availability.prefsheet'
        db.add_column('prodWeek_availability', 'prefsheet',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='availabilities', to=orm['prodWeek.PrefSheet']),
                      keep_default=False)

        # Adding unique constraint on 'Availability', fields ['prefsheet', 'day', 'hour']
        db.create_unique('prodWeek_availability', ['prefsheet_id', 'day', 'hour'])


    def backwards(self, orm):
        # Removing unique constraint on 'Availability', fields ['prefsheet', 'day', 'hour']
        db.delete_unique('prodWeek_availability', ['prefsheet_id', 'day', 'hour'])

        # Adding field 'Availability.name'
        db.add_column('prodWeek_availability', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)

        # Adding field 'Availability.prefsheetid'
        db.add_column('prodWeek_availability', 'prefsheetid',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Availability.prefsheet'
        db.delete_column('prodWeek_availability', 'prefsheet_id')

        # Adding unique constraint on 'Availability', fields ['prefsheetid', 'day', 'hour']
        db.create_unique('prodWeek_availability', ['prefsheetid', 'day', 'hour'])


    models = {
        'prodWeek.availability': {
            ...
            'prefsheet': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'related_name': "'availabilities'", 'to': "orm['prodWeek.PrefSheet']"})
        },
        'prodWeek.pref': {
            ...
            'prefsheet': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'prefs'", 'to': "orm['prodWeek.PrefSheet']"}),
